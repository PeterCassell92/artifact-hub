...
/**
 * Leaving feedback (`comment_on_artifact`) and summarising it back (`summarise_artifact_reviews`
 * prompt) — docs/architecture/05 §4/§6. The prompt injects comments as content; it never calls an
 * LLM itself (that's the client's model).
 */
